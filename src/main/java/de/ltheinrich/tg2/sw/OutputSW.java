...
public class OutputSW extends Generator {
    ...
    public OutputSW(int outputBit, int outputBitsStartIndex) {
        ...
        OutputEntry.builder()
                ...
                .PC_LD(0).PC_EN(1).PC_UP(1).RegADRtoRAM(0).AluStart(0).SWR(0)
                .build().addTo(entries);
        ...
        OutputEntry.builder()
                .Q(State.END)
                .WriteA(0).WriteRAM(0).WriteADR1(0).WriteADR2(0).WriteOP(-1)
                .PC_LD(0).PC_EN(1).PC_UP(0).RegADRtoRAM(0).AluStart(0).SWR(0)
                .build().addTo(entries);
        ...
        OutputEntry.builder()
                .Q(State.SWR)
                .WriteA(0).WriteRAM(0).WriteADR1(0).WriteADR2(0).WriteOP(-1)
                .PC_LD(0).PC_EN(0).PC_UP(-1).RegADRtoRAM(0).AluStart(0).SWR(1)
                .build().addTo(entries);
        ...
        OutputEntry.builder()
                .Q(State.ALU1)
                .WriteA(0).WriteRAM(0).WriteADR1(0).WriteADR2(0).WriteOP(-1)
                .PC_LD(0).PC_EN(0).PC_UP(-1).RegADRtoRAM(0).AluStart(1).SWR(0)
                .build().addTo(entries);
        ...
        OutputEntry.builder()
                .Q(State.ALU2)
                .WriteA(0).WriteRAM(0).WriteADR1(0).WriteADR2(0).WriteOP(-1)
                .PC_LD(0).PC_EN(0).PC_UP(-1).RegADRtoRAM(0).AluStart(0).SWR(0)
                .build().addTo(entries);
        ...
        OutputEntry.builder()
                ...
                .PC_LD(0).PC_EN(0).PC_UP(-1).RegADRtoRAM(1).AluStart(0).SWR(0)
                .build().addTo(entries);
        ...
        OutputEntry.builder()
                .Q(State.SET_PC)
                .WriteA(0).WriteRAM(0).WriteADR1(0).WriteADR2(0).WriteOP(-1)
                .PC_LD(1).PC_EN(0).PC_UP(-1).RegADRtoRAM(0).AluStart(0).SWR(0)
                .build().addTo(entries);
